...
benchmark_settings = {
    "Linux": {
        ...
        "regex": {r"(\d+\.){3}\d+" : "<*>", # IP
            r"[0-9a-f]{4}:[0-9a-f]{2}:[0-9a-f]{2}\.[0-9]" : "<*>", # PCIe BDF
            r"\d{2}:\d{2}:\d{2}" : "<*>", # time
            r"#011" : "", # escape char
            ...
            r"session-[0-9]+\.scope: Succeeded\." : "session-<*>.scope: Succeeded.",
            r"Removed session [0-9]+\." : "Removed session <*>.",
            r"Setting cpu: [0-9]+" : "Setting cpu: <*>"
            },
        "st": 0.39,
        "depth": 6,
    },
